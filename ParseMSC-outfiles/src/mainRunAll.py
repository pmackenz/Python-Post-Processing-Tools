...
last updated on May 22, 2017 by pmackenz
...
tasks = [
    ...
    #{'outfile':"../data/ws100cm.out", 'diameter':1.00,  'skindepth':all_skin_depth, 'startAtInc':0},
...
for task in tasks:
    ...
    if nskip > 0:
        ...
        print "skipped {} increments {:.2f}s:{:.2f}s".format(nskip-1, time.time() - time0, time.clock() - clock0)
